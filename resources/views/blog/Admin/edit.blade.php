    ...
    <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
        <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
            <div class="p-6 bg-white border-b border-gray-200">
                ...
                <form method="POST" action="{{route('Admin.update',$data->uuid)}}" class="mt-5">
                    @method('put')
                    @csrf
                    <div class="mb-4">
                        <label class="text-xl text-gray-600">Title <span class="text-red-500">*</span></label></br>
                        <input type="text" class="border-2 border-gray-300 p-2 w-full" name="title" id="title" value="{{old('title',$data->title)}}"/>
                    ...
                    <div class="flex p-1">
                        ...
                        <button role="submit" class="p-3 bg-blue-500 text-white hover:bg-blue-400 rounded" >Update Post</button>
                    </div>
                </form>
            </div>
        </div>
